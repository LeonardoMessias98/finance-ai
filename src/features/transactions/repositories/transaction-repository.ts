...
function mapTransactionDocument(document: HydratedDocument<TransactionDocument>): Transaction {
  return {
    ...
    creditPaymentMonth: document.creditPaymentMonth,
    categoryId: document.categoryId?.toString(),
    accountId: document.accountId.toString(),
    paymentForCreditAccountId: document.paymentForCreditAccountId?.toString(),
  ...
  const document = await TransactionModel.findOneAndUpdate(
    ...
    },
    {
      $set: {
        ...
        ...(payload.creditPaymentMonth ? { creditPaymentMonth: payload.creditPaymentMonth } : {}),
        accountId: payload.accountId,
        ...(payload.paymentForCreditAccountId ? { paymentForCreditAccountId: payload.paymentForCreditAccountId } : {}),
      ...
      $unset: {
        ...
        ...(payload.creditPaymentMonth ? {} : { creditPaymentMonth: 1 }),
        ...(payload.paymentForCreditAccountId ? {} : { paymentForCreditAccountId: 1 }),
